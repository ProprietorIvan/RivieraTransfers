  ...
  const services: ServiceCatalog = {
    "Everyday Handyman Services": {
      ...
      "Furniture assembly": {
        price: 150,
        maxPrice: 300,
        note: "depends on size/complexity",
      },
    ...
    "Outdoor Tasks": {
      ...
      "Pressure washing": {
        price: 200,
        maxPrice: 500,
        note: "based on area size",
      },
      "Fence and gate repairs": {
        price: 150,
        maxPrice: 400,
        note: "based on damage/length",
      },
    },
    Miscellaneous: {
      "Smart device setup": {
        price: 150,
        maxPrice: 300,
        note: "e.g., video doorbells, thermostats",
      },
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 mb-4">
                Select the services you need and schedule your appointment
              </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3 text-left mt-6">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-800 mt-1 space-y-1">
                    <li>
                      • Minimum order value of $250 required for all services
                    </li>
                    <li>
                      • For drywall repair services, please use our custom
                      quoting tool at{" "}
                      <a
                        href="https://az-handyman.ca/drywall"
                        className="text-blue-600 hover:text-blue-800 underline"
                      >
                        az-handyman.ca/drywall
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  ([category, categoryServices]) => (
                    ...
                    >
                      ...
                      <div className="divide-y divide-gray-200">
                        {Object.entries(categoryServices).map(
                          ([service, { price, maxPrice, note }]) => (
                            <div
                              key={service}
                ...
                {Object.keys(selectedServices).length > 0 && (
                  <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
                    <div className="text-xl font-semibold mb-4">
                      Estimated Total: ${calculateTotal().minTotal} - $
                      {calculateTotal().maxTotal}
                    </div>
                    {!meetsMinimumOrder() && (
                      <div className="text-red-600 text-sm mb-4">
                        * Please add more services to meet the minimum order
                        value of $250
                      </div>
                    )}
                    <button
