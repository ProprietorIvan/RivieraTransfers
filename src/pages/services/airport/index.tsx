...
const AirportTransferPage = () => {
    ...
    try {
      const response = await fetch("/api/email", {
        ...
        body: JSON.stringify({
          ...
          projectDetails: `Airport Transfer Details:
            Date: ${formData.date?.toLocaleDateString()}
            Time: ${formData.time}
            Passengers: ${formData.passengers}
            Flight Number: ${formData.flightNumber}
            Notes: ${formData.notes}`,
          facilityType: "Airport Transfer Service",
  ...
  const handleWhatsAppClick = () => {
    window.open(
      "https://wa.me/377678636346?text=Hello! I'm interested in booking an airport transfer service.",
      "_blank"
    );
  };
  ...
  const serviceFeatures = [
    {
      ...
      description: "Real-time flight monitoring for on-time pickups",
    },
    {
      icon: <Clock className="w-6 h-6" />,
      title: "24/7 Service",
      description: "Available for all flight times",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Professional Drivers",
      description: "Experienced and courteous",
    },
    {
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center py-16">
            <div className="w-full md:w-1/2">
              <div className="inline-block bg-black text-white px-4 py-1 rounded-full text-sm font-medium mb-6">
                Monaco&apos;s Premier Airport Transfer Service
              </div>
              <h1 className="text-5xl md:text-7xl font-bold mb-6 text-black">
                Luxury airport transfers.
                <span className="block text-black">Premium service.</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Experience seamless airport transfers between Nice Airport and
                Monaco with our luxury service.
              </p>
      ...
      <section className="py-20 bg-gray-50" id="booking-form">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Luxury service between Nice Airport and Monaco
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g., Nice Airport Terminal 1"
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-black focus:border-transparent"
                  required
                />
              </div>
