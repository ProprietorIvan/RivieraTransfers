...
const TransferLandingPage = () => {
    ...
    try {
      const response = await fetch("/api/email", {
        ...
        body: JSON.stringify({
          ...
          projectDetails: `Transfer Details:
            Date: ${formData.date?.toLocaleDateString()}
            Time: ${formData.time}
            Passengers: ${formData.passengers}
            Notes: ${formData.notes}`,
          facilityType: "Transfer Service",
  ...
  const handleWhatsAppClick = () => {
    window.open(
      "https://wa.me/377678636346?text=Hello! I'm interested in booking a transfer service.",
      "_blank"
    );
  };
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center py-16">
            <div className="w-full md:w-1/2">
              <div className="inline-block bg-black text-white px-4 py-1 rounded-full text-sm font-medium mb-6">
                Monaco&apos;s Premier Transfer Service
              </div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Experience the epitome of comfort with our luxury transfer
                service between Monaco and Nice Airport.
              </p>
      ...
      <section className="py-20 bg-gray-50" id="booking-form">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Luxury service between Monaco and Nice Airport
            </p>
          </div>
